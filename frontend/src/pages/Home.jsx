...
const Home = ({ user }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      {user ? (
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl w-full max-w-lg p-8 border border-indigo-100">
          ...
          <form
            onSubmit={addTodo}
            className="flex items-center gap-2 border border-indigo-200 p-2 rounded-lg bg-white shadow-sm"
          >
            <input
              className="flex-1 outline-none px-3 py-2 text-gray-700 placeholder-gray-400 focus:ring-2 focus:ring-indigo-300 rounded-lg"
              type="text"
              value={newTodo}
                  ...
                  >
                    {editingTodo === todo._id ? (
                      <div className="flex items-center gap-x-3 w-full">
                        <input
                          className="flex-1 p-2 border rounded-lg border-gray-300 outline-none focus:ring-2 focus:ring-indigo-300 text-gray-700"
                          type="text"
                          value={editedText}
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl w-full max-w-md p-8 text-center border border-indigo-100">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              to="/register"
              className="px-5 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg shadow transition"
            >
              Register
            </Link>
          </div>
